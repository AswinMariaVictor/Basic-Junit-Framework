...
public class Base_Class {
	...
	public static String value; // read_Particular Excel data
...
//Implicit/Global wait
	public static void implicitWait( Duration time) {
		driver.manage().timeouts().implicitlyWait(time);
	}

//Explicit wait
	public static void waitForElementIsVisible(Duration time, WebElement element) {
		WebDriverWait wait = new WebDriverWait(driver, time);
		wait.until(ExpectedConditions.visibilityOf(element));
	}

// Fluent Wait
	public static void fluentWait(int timeOut, int pollingInterval)
	{
...
//send keys()
	public static void inputValueElement(WebElement element, String value, Duration time ) {
		waitForElementIsVisible(time, element);
